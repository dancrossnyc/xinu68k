 ...
 */
int
_doscan(char *fmt,		/* Format string for the scanf  */
	int **argp,		/* Arguments to scanf           */
	int (*getch) (void),	/* Function to get a character  */
	int (*ungetch) (void),	/* Function to unget a character */
...
int
_innum(int **ptr, int type, int len, int size, int (*getch) (void),
       int (*ungetch) (void), int arg1, int arg2, int *eofptr)
{
	extern double atof();
	char *np;
	char numbuf[64];
...
int
_instr(char *ptr, int type, int len, int (*getch) (void),
       int (*ungetch) (void), int arg1, int arg2, int *eofptr)
{
	int ch;
	char *optr;
